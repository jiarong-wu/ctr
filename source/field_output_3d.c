...
event init(i=0)
{
  ...
  for (int i=0; i<Nslice; i++) {
    sprintf (filename, "./field/ux_t%g_zslice%d", snapshot_time, i);
    sliceXY (filename,u.x,zslice,OUTLEVEL,do_linear);
    sprintf (filename, "./field/uy_t%g_zslice%d", snapshot_time, i);
    sliceXY (filename,u.y,zslice,OUTLEVEL,do_linear);
    sprintf (filename, "./field/uz_t%g_zslice%d", snapshot_time, i);
    sliceXY (filename,u.z,zslice,OUTLEVEL,do_linear);
    sprintf (filename, "./field/f_t%g_zslice%d", snapshot_time, i);
    sliceXY (filename,f,zslice,OUTLEVEL,do_linear);
    // sprintf (filename, "./field/pair_t%g_zslice%d", t, i);
    // sliceXY (filename,pair,zslice,OUTLEVEL,do_linear);
    zslice += L0/Nslice;
  }
  fprintf (stderr, "Slices in z output finished!\n");

  // Redundand and not needed unless we want to save only a few heights
  // double yslice = 0.+L0/2./Nslice;
  // for (int i=0; i<Nslice; i++) {
  //   sprintf (filename, "./field/ux_t%g_yslice%d", snapshot_time, i);
  //   sliceXZ (filename,u.x,yslice,OUTLEVEL,do_linear);
  //   sprintf (filename, "./field/uy_t%g_yslice%d", snapshot_time, i);
  //   sliceXZ (filename,u.y,yslice,OUTLEVEL,do_linear);
  //   sprintf (filename, "./field/uz_t%g_yslice%d", snapshot_time, i);
  //   sliceXZ (filename,u.z,yslice,OUTLEVEL,do_linear);
  //   sprintf (filename, "./field/f_t%g_yslice%d", snapshot_time, i);
  //   sliceXZ (filename,f,yslice,OUTLEVEL,do_linear);
  //   // sprintf (filename, "./field/pair_t%g_yslice%d", t, i);
  //   // sliceXZ (filename,pair,yslice,OUTLEVEL,do_linear);
  //   yslice += L0/Nslice;
  // }
  // fprintf (stderr, "Slices in y output finished!\n");
